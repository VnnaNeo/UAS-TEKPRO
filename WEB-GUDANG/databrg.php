...
<html lang="en">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <input class="form-control me-2" type="text" name="keyword" placeholder="Cari Barang" aria-label="Search">
    ...
    <div class="container">
        ...
        <?php
            ...
            $query = $_POST['keyword'];
            if ($query != ''){
                $select = mysqli_query($db, "SELECT * FROM barang WHERE id_barang LIKE '".$query."' OR 
                nama_barang LIKE '%".$query."%'");
            }else{
                $select = mysqli_query($db, "SELECT * FROM barang");
            }
        ...
        <?php }}else{
            echo '<tr><td scope="col">Tidak ada data</tr></td>';
        } ?>
        </table>
