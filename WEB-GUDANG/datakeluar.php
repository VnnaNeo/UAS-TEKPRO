...
$query = mysqli_query($db, "SELECT * FROM barang_keluar");
?>
...
<html lang="en">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item">
        <a href="barangkeluar.php" class="btn btn-primary">TAMBAH BARANG KELUAR</a>
        </li>
    </ul>
    </div>
    ...
    <div class="container">
        ...
        <tbody>
        <tr>
        <td scope="col"><?php echo $row['id_transaksi']; ?> </td>
        <td><?php echo $row['tanggal_keluar']; ?> </td>
        <td><?php echo $row['nama_barang']; ?> </td>
        <td><?php echo $row['jumlah_keluar']; ?> </td>
        
        <td><a href="ubahkeluar.php?id_transaksi=<?php echo $row['id_transaksi']?>" class="btn btn-success">UBAH</a>
        </td>
        <td><a href="hapuskeluar.php?id_transaksi=<?php echo $row['id_transaksi']?>" class="btn btn-danger">HAPUS</a>
        </td>
        </tr>
        <?php } ?>
        </table>
