...
$id_brg = $_GET['id_transaksi'];
$query = mysqli_query($db, "SELECT * FROM barang_keluar WHERE id_transaksi='$id_brg' ");
...
<html lang="en">
    ...
    <div class="container">
        <h4 class="text-center">Ubah Deskripsi Barang Keluar</h4>
        <hr>
    ...
    <form action ="proses_ubah.php" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="number" required name="stok" class="form-control" placeholder="Masukkan Stok Barang" value="<?php echo $row['stok']?>">
        </div>
